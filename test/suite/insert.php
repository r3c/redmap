...
(
	...
	function () use ($engine, $message) { return $engine->select ($message, array ('id' => 3)); },
...
test_insert
(
	function () use ($engine, $message) { return $engine->insert ($message, array ('id' => 3, 'sender' => 42), RedMap\Engine::INSERT_UPSERT); },
	function () use ($engine, $message) { return $engine->select ($message, array ('id' => 3)); },
...
test_insert
(
	function () use ($engine, $message) { return $engine->insert ($message, array ('id' => 3, 'sender' => new RedMap\Increment (1, 42)), RedMap\Engine::INSERT_UPSERT); },
	function () use ($engine, $message) { return $engine->select ($message, array ('id' => 3)); },
	array (array ('id' => 3, 'sender' => 42, 'recipient' => 0, 'time' => 0, 'text' => ''))
);
...
test_insert
(
	function () use ($engine, $message) { return $engine->insert ($message, array ('id' => 2, 'sender' => 53, 'text' => 'Upserted!'), RedMap\Engine::INSERT_UPSERT); },
	function () use ($engine, $message) { return $engine->select ($message, array ('id' => 2)); },
...
test_insert
(
	function () use ($engine, $message) { return $engine->insert ($message, array ('id' => 2, 'sender' => new RedMap\Increment (1, 53), 'recipient' => new RedMap\Max (3), 'time' => new RedMap\Min (2000), 'text' => 'Upserted!'), RedMap\Engine::INSERT_UPSERT); },
	function () use ($engine, $message) { return $engine->select ($message, array ('id' => 2)); },
...
test_insert
(
	function () use ($engine, $message) { return $engine->insert ($message, array ('id' => 3, 'sender' => 1, 'recipient' => 9, 'time' => 0, 'text' => 'Replaced!'), RedMap\Engine::INSERT_REPLACE); },
	function () use ($engine, $message) { return $engine->select ($message, array ('id' => 3)); },
...
test_insert
(
	function () use ($engine, $message) { return $engine->insert ($message, array ('id' => 3, 'sender' => new RedMap\Coalesce (1), 'recipient' => 9, 'time' => 0, 'text' => 'Replaced!'), RedMap\Engine::INSERT_REPLACE); },
	function () use ($engine, $message) { return $engine->select ($message, array ('id' => 3)); },
	array (array ('id' => 3, 'sender' => 1, 'recipient' => 9, 'text' => 'Replaced!', 'time' => 0))
);
...
test_insert
(
	function () use ($engine, $message) { return $engine->insert ($message, array ('id' => 2, 'recipient' => 7), RedMap\Engine::INSERT_REPLACE); },
	function () use ($engine, $message) { return $engine->select ($message, array ('id' => 2)); },
...
test_insert
(
	function () use ($engine, $message) { return $engine->insert ($message, array ('id' => 2, 'sender' => new RedMap\Min (5), 'recipient' => new RedMap\Max (0)), RedMap\Engine::INSERT_REPLACE); },
	function () use ($engine, $message) { return $engine->select ($message, array ('id' => 2)); },
